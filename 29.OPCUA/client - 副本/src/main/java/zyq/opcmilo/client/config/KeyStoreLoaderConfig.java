...
/**
 * @Description OPC UA访问证书类
 */
public class KeyStoreLoaderConfig {
    ...
    public KeyStoreLoaderConfig load(Path baseDir) throws Exception {
        ...
        if (!Files.exists(serverKeyStore)) {
            ...
            // `SelfSignedCertificateBuilder`也是Milk库的对象，用来生成证书。
            // 中间所设置的证书属性可以自行修改。
