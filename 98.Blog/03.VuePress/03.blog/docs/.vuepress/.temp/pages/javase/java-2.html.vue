<template><div><h1 id="java语言基础-中" tabindex="-1"><a class="header-anchor" href="#java语言基础-中" aria-hidden="true">#</a> Java语言基础（中）</h1>
<h2 id="第8章-多线程基础" tabindex="-1"><a class="header-anchor" href="#第8章-多线程基础" aria-hidden="true">#</a> 第8章 多线程基础</h2>
...
<p><img src="/images/javase/java-2/image.png" alt="image.png" loading="lazy"></p>
...
<li>同步监视器一般情况：
<ul>
<li>在实现Runnable接口创建多线程的方式中，可以考虑使用this充当同步监视器。
在继承Thread类创建多线程的方式中，慎用this充当同步监视器，考虑使用当前类充当同步监视器。</li>
</ul>
</li>
</ol>
...
<li><img src="/images/javase/java-2/image-1660812212181.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
...
<li>TreeMap</li>
<li><img src="/images/javase/java-2/image-1660812218745.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
</ol>
...
<ul>
<li><img src="/images/javase/java-2/image-1660812227166.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
</ol>
...
<li>解决方式：（去掉下列两个红框的勾选）。
<ul>
<li><img src="/images/javase/java-2/image-1660812232833.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li><img src="/images/javase/java-2/image-1660812278755.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
</ol>
...
<li>相同数据只能存放一个
<ul>
<li>注意字符串的特殊性（面试题）：<img src="/images/javase/java-2/image-1660812285548.png" alt="image.png" loading="lazy"></li>
<li>其他对象可以添加成功：<img src="/images/javase/java-2/image-1660812287543.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
...
<li><img src="/images/javase/java-2/image-1660812291859.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
<li>源码个人理解：
<ul>
...
<li>Map.Entry有重要的<code v-pre>getKey()</code>、<code v-pre>getValue()</code>可以获取元素的k-v值，有了这两个方法，就大大方便了使用（遍历）。<img src="/images/javase/java-2/image-1660812294638.png" alt="image.png" loading="lazy">
<ul>
...
<ul>
<li>EntrySet和Node都是HashMap的内部类<img src="/images/javase/java-2/image-1660812296959.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li><img src="/images/javase/java-2/image-1660812299482.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
</ol>
...
<ul>
<li>前提条件：使用向上转型，转为Map.Entry。<img src="/images/javase/java-2/image-1660812327949.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
<li>使用迭代器：
<ul>
...
<li><img src="/images/javase/java-2/image-1660812332456.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
</ul>
</li>
...
<li><img src="/images/javase/java-2/image-1660812335569.png" alt="image.png" loading="lazy"></li>
...
<li>底层：
<ul>
<li>底层是一个数组，类型为<code v-pre>Hashtable$Entry</code>，实现了Map.Entry。元素类型也为<code v-pre>Hashtable$Entry</code><img src="/images/javase/java-2/image-1660812338767.png" alt="image.png" loading="lazy"></li>
<li>初始化大小为11，临界值为8（11*0.75）</li>
<li>当添加数据数量到达8时，对数组进行扩容，扩容为当前容量 <em>2 + 1，新的临界值变为当前容量</em> 0.75</li>
</ul>
</li>
</ol>
...
<ul>
<li>底层就是Entry</li>
<li>存放的数据类型是<code v-pre>TreeMap$Entry</code><img src="/images/javase/java-2/image-1660812342500.png" alt="image.png" loading="lazy"></li>
<li>初始化大小是0，添加一个容量+1</li>
</ul>
</li>
</ol>
...
<img src="/images/javase/java-2/image-1660812344841.png" alt="image.png" loading="lazy"></p>
</div>
...
<ol>
<li>
<p><code v-pre>getGenericSuperclass()</code>：与<code v-pre>getSuperclass()</code>方法类似，获取带泛型的父类类型。返回类型为<code v-pre>Type</code>。</p>
</li>
<li></li>
</ol>
...
<p><img src="/images/javase/java-2/image-1660812413575.png" alt="image.png" loading="lazy"></p>
<blockquote>
<ul>
<li>不对，泛型没有继承性</li>
</ul>
...
<p>通配符注意点：
<img src="/images/javase/java-2/image-1660812415631.png" alt="image.png" loading="lazy"></p>
...
<p><img src="/images/javase/java-2/image-1660812426394.png" alt="image.png" loading="lazy"></p>
<table>
<thead>
<tr>
<th>抽象基类</th>
...
<p><img src="/images/javase/java-2/java.io.png" alt="java.io.png" loading="lazy"></p>
...
<p><img src="/images/javase/java-2/image-1660812444522.png" alt="image.png" loading="lazy"><img src="/images/javase/java-2/image-1660812447800.png" alt="image.png" loading="lazy"></p>
<ol start="6">
...
<p><img src="/images/javase/java-2/image-1660812454319.png" alt="image.png" loading="lazy"></p>
<ol>
...
<p><img src="/images/javase/java-2/image-1660812457001.png" alt="image.png" loading="lazy"></p>
<ol start="3">
<li>UDP协议（用户数据协议）
<ul>
...
<p><img src="/images/javase/java-2/image-1660812459772.png" alt="image.png" loading="lazy"></p>
<h4 id="_12-3-1-tcp网络通信编程" tabindex="-1"><a class="header-anchor" href="#_12-3-1-tcp网络通信编程" aria-hidden="true">#</a> 12.3.1 TCP网络通信编程</h4>
<p><img src="/images/javase/java-2/image-1660812461813.png" alt="image.png" loading="lazy"></p>
<ul>
...
<p><img src="/images/javase/java-2/image-1660812465294.png" alt="image.png" loading="lazy"></p>
...
<ul>
<li><img src="/images/javase/java-2/image-1660812468885.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
...
<p><img src="/images/javase/java-2/image-1660812471119.png" alt="image.png" loading="lazy"></p>
<ul>
...
<p><img src="/images/javase/java-2/image-1660812475858.png" alt="image.png" loading="lazy"></p>
<ol>
...
<ul>
<li><img src="/images/javase/java-2/image-1660812482170.png" alt="image.png" loading="lazy"></li>
</ul>
</li>
...
<p><img src="/images/javase/java-2/image-1660812485739.png" alt="image.png" loading="lazy">
<img src="/images/javase/java-2/image-1660812487921.png" alt="image.png" loading="lazy"></p>
<ul>
...
<p><img src="/images/javase/java-2/image-1660812491428.png" alt="image.png" loading="lazy"></p>
...
<p><img src="/images/javase/java-2/image-1660812493253.png" alt="image.png" loading="lazy"></p>
<ul>
...
<p><img src="/images/javase/java-2/image-1660812495093.png" alt="image.png" loading="lazy"></p>
<ul>
...
<p><img src="/images/javase/java-2/image-1660812496848.png" alt="image.png" loading="lazy"></p>
