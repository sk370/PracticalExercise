...
<ul>
<li>spring-boot-starter-web底层基础依赖是spring-boot-starter，是所有场景启动最底层的依赖。</li>
<li>*-spring-boot-starter： 第三方提供的简化开发的场景启动器。</li>
<li></li>
</ul>
</li>
</ol>
...
<ul>
<li>
<h2 id="参照文档修改配置项" tabindex="-1"><a class="header-anchor" href="#参照文档修改配置项" aria-hidden="true">#</a> 参照文档修改配置项</h2>
<ul>
